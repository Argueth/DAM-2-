...
import com.pabloginerbarrios.probandocamara.databinding.ActivityCamaraBinding
import java.io.File
...
class Camara : AppCompatActivity() {
    ...
    private fun bindCamera() {
        ...
        val cameraProvider = cameraProvider?: throw IllegalStateException("Fallo al iniciar la cámara.")
    ...
    private fun getOutputDirectory(): File {
        val mediaDir = externalMediaDirs.firstOrNull()?.let{
            File(it, "TakenPhotos").apply { mkdirs() }
        }
